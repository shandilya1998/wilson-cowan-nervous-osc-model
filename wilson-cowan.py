...
osc = WilsonCowan(Tu = 0.2, Tv = 1, a = 5.6, d = -2.4, b = 5.6, c = 2.4, Su = 0.02, Sv = 0.02, mu = 1)
osc.simulate()#disturb_time = 5000000)
fig, axes = plt.subplots(3, 1, figsize = (5, 15))
axes[0].plot(osc.Au[5000000-5000:5000000+5000])
axes[0].set_ylabel('excitatory neuron output')
axes[0].set_xlabel('time')
axes[1].plot(osc.Av[5000000-5000:5000000+5000])
axes[1].set_ylabel('inhibitory neuron output')
axes[1].set_xlabel('time')
axes[2].plot(osc.Ay[5000000-5000:5000000+5000])
axes[2].set_ylabel('CPG output')
axes[2].set_xlabel('time')
fig.savefig('plots/wilson_cowan_exp4.png')
plt.show()
